...
impl From<&[u8]> for Keyword {
    ...
    fn from(i: &[u8]) -> Self {
        match i {
            ...
            b"FZALGOR " => Keyword::FZAlgor, //order is important, needs to be before FZALGn
            i if i.starts_with(b"FZALG") => Keyword::new("FZALG", i),
            ...
            i if i.starts_with(b"NAXIS") => Keyword::new("NAXIS", i),
            b"OBJECT  " => Keyword::Object,
            b"OBS     " => Keyword::Obs,
            b"OBSERVER" => Keyword::Observer,
            b"ORIGIN  " => Keyword::Origin,
            b"PCOUNT  " => Keyword::PCount,
            i if i.starts_with(b"PSCAL") => Keyword::new("PSCAL", i),
            i if i.starts_with(b"PTYPE") => Keyword::new("PTYPE", i),
            i if i.starts_with(b"PZERO") => Keyword::new("PZERO", i),
            b"REFERENC" => Keyword::Referenc,
            b"SIMPLE  " => Keyword::Simple,
            i if i.starts_with(b"TBCOL") => Keyword::new("TBCOL", i),
            i if i.starts_with(b"TDMAX") => Keyword::new("TDMAX", i),
            i if i.starts_with(b"TDMIN") => Keyword::new("TDMIN", i),
            i if i.starts_with(b"TDIM") => Keyword::new("TDIM", i),
            i if i.starts_with(b"TDISP") => Keyword::new("TDISP", i),
            i if i.starts_with(b"TFORM") => Keyword::new("TFORM", i),
            b"THEAP   " => Keyword::THeap,
            i if i.starts_with(b"TLMAX") => Keyword::new("TLMAX", i),
            i if i.starts_with(b"TLMIN") => Keyword::new("TLMIN", i),
            i if i.starts_with(b"TNULL") => Keyword::new("TNULL", i),
            i if i.starts_with(b"TSCAL") => Keyword::new("TSCAL", i),
            i if i.starts_with(b"TTYPE") => Keyword::new("TTYPE", i),
            i if i.starts_with(b"TUNIT") => Keyword::new("TUNIT", i),
            i if i.starts_with(b"TZERO") => Keyword::new("TZERO", i),
            ...
            i if i.starts_with(b"ZTILE") => Keyword::new("ZTILE", i),
            i if i.starts_with(b"ZVAL") => Keyword::new("ZVAL", i),
